...
if __name__ == '__main__':
    ...
    if (len(args)==5):
        ...
        save_field_video("bin/"+pname+"_EMField_{cycle:08}.bin"          ,"delBz"           ,"[mT]"    ,3,dt,start,end ,"fig/"+pname+"_from"+args[3]+"_to"+args[2]+"_delBz.mp4"          ,vmin=dict_cmin.get("delBz")          ,vmax=dict_cmax.get("delBz")         ,fps=30)
        ## 1d plot
